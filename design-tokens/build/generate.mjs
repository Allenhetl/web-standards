...
const THEME_TARGETS = {
  "allen-blue": [
    { target: "scss", out: "dist/allen-blue", file: "_tokens.scss" },
  ],
  // phd theme + inlinable-css target land in Phase 3.
};
...
function emitScss(contract, theme, model) {
  ...
  const order = ["color", "type", "motion", "shape", "shadow"];
  const catLabel = {
    color: "Color",
    type: "Typography",
    motion: "Motion",
...
const EMITTERS = { scss: { fn: emitScss, filename: "_tokens.scss" } };
